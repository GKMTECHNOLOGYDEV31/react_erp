...
const InicioPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!captchaChecked) {
      toastr.error('Confirma que no eres un robot 🤖', 'Verificación requerida');
      return;
    }
    ...
    try {
      ...
      if (error.response?.status === 401) {
        toastr.error('Documento o contraseña incorrectos', 'Error de autenticación');
      } else {
            ...
            <div className="w-full max-w-md">
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-3xl overflow-hidden border border-white/20">
                ...
                <div className="pt-8 pb-2 flex justify-center items-center gap-3 bg-gradient-to-b from-white to-gray-50/50">
                  ...
                  <span
                    className="text-3xl font-black text-[#D11D1D] tracking-wider"
                    style={{
                ...
                <div className="p-6 pt-2">
                  <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <div>
                      <label
                        htmlFor="password"
                        className="block text-sm font-medium text-gray-700 mb-1 drop-shadow-sm"
                      >
                        Contraseña
                      </label>
                      <input
                    ...
                    <div className="border border-gray-200 rounded-lg p-4 bg-gradient-to-br from-gray-50 to-white shadow-md hover:shadow-lg transition-shadow duration-300">
                      ...
                      <div className="mt-2 flex gap-3 text-[10px]">
                        <span className="text-gray-400 hover:text-[#D11D1D] cursor-pointer transition-colors drop-shadow-sm">
                          Privacidad
                        </span>
                    ...
                    <div className="pt-4 mt-2 border-t border-gray-200">
                      <p className="text-xs text-center text-gray-500 mb-3 drop-shadow-sm">
                        Síguenos en nuestras redes
                      </p>
                      <div className="flex justify-center space-x-4">
                        {/* Facebook */}
                        <a
                          href="https://www.facebook.com/gkmtechnologype/?locale=es_LA"
                          target="_blank"
                        ...
                        {/* Instagram */}
                        <a
                          href="https://www.instagram.com/gkmtechnology"
                          target="_blank"
                          rel="noopener noreferrer"
                        ...
                        {/* LinkedIn */}
                        <a
                          href="https://www.linkedin.com/company/gkm-technologype/"
                          target="_blank"
                          rel="noopener noreferrer"
